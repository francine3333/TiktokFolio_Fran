...
var user1 = new User(0o1, "Gamer Girl", "none", "picture/dp.png", true);
var user2 = new User(0o2, "Noyam Jingo", "none", "picture/dp.png", true);
var user3 = new User(0o3, "Huwan Girl", "verified", "picture/dp.png", false);
var user4 = new User(0o4, "Rage NOma", "none", "picture/dp.png", true);
...
document.getElementById("category-dropdown").addEventListener("change", function () {
  ...
  // Show the selected items based on the selection
  ...
  if (selectedValue === "all") {
    ...
    // Display only the items with matching data-category
    items.forEach(item => {
      const category = item.getAttribute("data-category");
      console.log(`Item category: ${category}, Selected value: ${selectedValue}`);
